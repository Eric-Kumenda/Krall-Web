    ...
    return (
      <Link href={href} onClick={() => setIsMobileMenuOpen(false)}>
        <div
          className={`
            flex items-center 
            ${isMobileMenuOpen ? "justify-start px-4 w-full" : "justify-center w-10"} 
      ...
      `}>
        ...
        <nav
          className={`flex flex-col ${
            isMobileMenuOpen ? "items-start w-full mt-4" : "items-center"
          }`}>
        ...
        <div
          ...
          <div
            className={`
                ...
                ${isMobileMenuOpen ? "justify-start w-full px-2" : "justify-center w-12"}
                h-12 my-2 p-1 
            ...
            {isMobileMenuOpen && (
              <div className="ml-3 overflow-hidden" onClick={handleToggleDropdown}>

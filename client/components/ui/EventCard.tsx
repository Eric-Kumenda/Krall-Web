...
export default function EventCard({
	...
	return (
		<div className="group relative flex flex-col lg:flex-row gap-6 bg-gray-900/50 border border-gray-800 rounded-3xl p-4 hover:bg-gray-800/50 transition-all duration-300 hover:border-primary/30 overflow-hidden">
			...
			{/* <div className="hidden lg:flex flex-col items-center justify-start pt-2 absolute -top-10 right-4">
				<Lanyard />
			</div> */}
			{/* Image Column */}
			...
			<div className="flex-grow flex flex-col justify-between py-2 pr-4">
				<div>
					<div className="flex items-start justify-between gap-4 mb-3">
						...
						<div className="hidden lg:block text-center px-4 border-l border-gray-700/50">
							...
							<span className="block text-sm uppercase tracking-wider text-gray-400">
								{month}
							</span>
						</div>
					</div>
				...
				<div className="flex items-center gap-4 mt-auto">
					...
					<Link
						href={`/events/${id}`}
						className="text-gray-400 hover:text-white text-sm font-bold transition-colors px-4 py-2 rounded-full hover:bg-white/5">
						View Details
					</Link>
				</div>
			</div>

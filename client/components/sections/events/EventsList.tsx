...
import { Calendar, Music, BookOpen, Palette, Trophy, Film } from 'lucide-react';
...
const eventsData = [
  {
    ...
    description: 'Experience a curated collection of contemporary African art featuring emerging artists from across the continent. Join us for an evening of culture, conversation, and creativity.',
    imageUrl: 'https://images.unsplash.com/photo-1561489396-888724a1543d?w=800&auto=format&fit=crop&q=60',
  ...
  },
  {
    ...
    description: 'An intimate evening of live acoustic performances by local talents. Enjoy soulful melodies under the stars in our open-air amphitheater.',
  ...
  },
  {
    ...
    description: 'Learn the art of digital storytelling with industry experts. This hands-on workshop covers scriptwriting, filming techniques, and editing basics.',
  ...
  },
  {
    ...
    description: 'Join hands with us to make our neighborhood cleaner and greener. A community initiative to promote environmental awareness and civic responsibility.',
  ...
  },
  {
    ...
    description: 'A special screening of award-winning short films by young African directors. Followed by a Q&A session with the filmmakers.',
